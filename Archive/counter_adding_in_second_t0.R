...
plot(-log10(FDR) ~ LFC,
		 data = melted_results[condition == "mouse_plated_10x_inoculum_dilution - inoculum_pellet_t0"],
		 pch = 20,
		 main = "Guide-level: mouse_plated_10x_inoculum_dilution - inoculum_pellet_t0")
...
# plot(-log10(FDR)~medLFC, data = median_melted_results[condition == "mouse_plated_10x_inoculum_dilution - inoculum_pellet_t0"], pch = 20, main = "Gene-level (Median guide): mouse_plated_10x_inoculum_dilution - inoculum_pellet_t0")
# abline(v = median_melted_results[condition == "mouse_plated_10x_inoculum_dilution - inoculum_pellet_t0" & type == "control"]$medLFC)
...
to_plot <-
	melted_results[condition == "mouse_plated_10x_inoculum_dilution - inoculum_pellet_t0"]
