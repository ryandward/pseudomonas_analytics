...
bottlenecked_levels <- data_grid[, .(fis = (Mouse_P1_017 / sum(Mouse_P1_017)), fio = Mouse_P1_005/sum(Mouse_P1_005))]
...
Nb = 10 / ( f_hat - 1 / data_grid[, sum(Mouse_P1_005)] - 1/data_grid[, sum(Mouse_P1_005)])
